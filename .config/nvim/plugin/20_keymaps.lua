...
nmap_leader('bw', '<Cmd>lua MiniBufremove.delete()<CR>', 'Delete')
nmap_leader('bW', '<Cmd>lua MiniBufremove.delete(0, true)<CR>', 'Delete!')
nmap_leader('bs', new_scratch_buffer, 'Scratch')
nmap_leader('bd', '<Cmd>lua MiniBufremove.wipeout()<CR>', 'Wipeout')
nmap_leader('bD', '<Cmd>lua MiniBufremove.wipeout(0, true)<CR>', 'Wipeout!')
...
local explore_locations = function()
	vim.cmd(
		vim.fn.getloclist(0, { winid = true }).winid ~= 0 and 'lclose' or 'lopen'
	)
end
...
-- mini.ai overrides default lsp incremental selection
